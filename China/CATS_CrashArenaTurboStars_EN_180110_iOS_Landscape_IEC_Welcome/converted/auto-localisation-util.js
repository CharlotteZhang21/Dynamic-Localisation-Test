...
function getLocalisedCta() {
	var language = getBrowserLanguage();
    var downloadText = "play";
    var font = 'myFont';
    var fontMarginTopMultiplier = 0.25;
    var fontSizeMultiplier = 0.32;
    var marginRight = 20;
    switch (language) {
        case "en":
            downloadText = "play";
            ...
            fontMarginTopMultiplier = 0.2;
            break;
        case "ja":
            downloadText = "ダウンロード";
            font = 'asian';
            fontSizeMultiplier = 0.23;
            fontMarginTopMultiplier = 0.3;
            marginRight = 30;
            break;
        case "ko":
            downloadText = "다운로드";
    ...
    return {
        'text' : downloadText, 
        'font' : font, 
        'fontMarginTopMultiplier': fontMarginTopMultiplier, 
