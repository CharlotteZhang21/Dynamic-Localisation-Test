...
gulp.task('watch', () => {
  gulp.watch(['src/js/*.js', 'src/game/js/**/*.js', 'src/game/img/**/*', 'src/index.html', 'src/css/*.css'], ['replace-js', 'reload', 'copy']);
});

gulp.task('dev-watch', () => {
  gulp.watch(['src/js/*.js', 'src/game/js/**/*.js', 'src/game/img/**/*', 'src/index.html', 'src/css/*.css'], ['dev-replace-js', 'dev-reload', 'dev-copy']);
});
